...
import { ZoomSubMenuBuilder } from "./ZoomSubMenuBuilder";

class ZoomSideMenuBuilder extends SideMenuBuilder {
  ...
  getZoomSubMenu(hasActiveTab: boolean) {
    const zoomSubMenuBuilder = new ZoomSubMenuBuilder(
      this.appController,
    ...
    zoomSubMenuBuilder.createList(hasActiveTab);
    return zoomSubMenuBuilder.getList();
  }
  ...
  getSideMenuItem(hasActiveTab: boolean) {
    return new SideMenuItem({
      ...
      submenu: this.getZoomSubMenu(hasActiveTab),
    });
  }
}

export { ZoomSideMenuBuilder };
module.exports = { ZoomSideMenuBuilder };
